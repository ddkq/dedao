...
<nav class="header-nav position-fixed">
	<ul class="d-flex justify-content-between">
		...
		<div class="brand_main clearfix">
			...
			<div class="brand_rongyu_info"><?php echo ($post_phone); ?></div>
...
<script>
	...
	<script type="text/javascript">
		...
		var sContent =  
			...
			"<p style='margin:0;line-height:1.5;font-size:0.8rem;'>地址：深圳市南山区桂庙路南侧5号龙意成大楼8/9楼<br/>电话：400-800-6161 / 0755-86522406</p>" +  
			"</div>";  
