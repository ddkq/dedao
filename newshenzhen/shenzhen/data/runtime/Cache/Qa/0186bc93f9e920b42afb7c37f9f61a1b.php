	...
	<ul class="d-flex justify-content-between">
		...
		<div class="main_list">
			<div class="term_title media">
				<div class="media-left media-middle"><img src="/themes/simplebootx_mobile/Public/images/manage_fill.png" /></div>
				<div class="media-body"><?php echo ($name); ?></div>
				<i class="fa fa-plus show_child"></i>
			</div>
			<ul class="termchild_list clearfix">
				<?php if(is_array($childterm)): $i = 0; $__LIST__ = $childterm;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li class="col-xs-4"><a href="/qa/list/<?php echo ($vo["term_id"]); ?>.html"><?php echo ($vo["name"]); ?></a></li><?php endforeach; endif; else: echo "" ;endif; ?>
			</ul>
			<ul class="lists">
				<?php if(is_array($allquestion['posts'])): $i = 0; $__LIST__ = $allquestion['posts'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li>
						<a class="media" href="/qa/<?php echo ($vo["id"]); ?>.html">
							<div class="media-body">
								<p><?php echo ($vo["title"]); ?></p>
								<p class="time">回答数：<?php echo ($vo["answer_num"]); ?>个回答 </p>
							</div>
			...
			<ul class="page"><?php echo ($allquestion['page']); ?></ul>
		</div>
		<div class="copy">
