...
<body>
	<div class="wrap">
		<ul class="nav nav-tabs">
			<li class="active"><a href="<?php echo U('AdminQaTerm/index');?>"><?php echo L('PORTAL_ADMINTERM_INDEX');?></a></li>
			<li><a href="<?php echo U('AdminQaTerm/add');?>"><?php echo L('PORTAL_ADMINTERM_ADD');?></a></li>
		</ul>
		<form method="post" class="js-ajax-form" action="<?php echo U('AdminQaTerm/index');?>">
