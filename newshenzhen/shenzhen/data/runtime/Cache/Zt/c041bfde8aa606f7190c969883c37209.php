...
<html>
	<head>
	<meta charset="UTF-8">
	<title>5000种牙补贴补贴_<?php echo ($site_name); ?></title>
...
<script language="javascript" src="http://swt.szddkqyy.com/JS/LsJS.aspx?siteid=MTI57225838&lng=cn"></script>
	...
	<link href="/themes/simplebootx_mobile/Zt/20190712/index.css" rel="stylesheet" type="text/css">
...
<body>
	<section class=""><img src="/themes/simplebootx_mobile/Zt/20190712/imgs/1-1.jpg" /></section>
	...
	<section class="">
		<form action="" class="container mt-3 mb-4">
			...
			<input type="text" class="w-100 pt-3 pb-3 mt-2 age"  name="data[age]" placeholder="年龄">
		...
		<p class="text-center pt-2 mb-3">
			<a href="javascript:;" class="text-center text-white w-75 submit-btn pt-2 pb-2 d-inline-block">快速领取</a>
		</p>

		<div class="">
			<img src="/themes/simplebootx_mobile/Zt/20190712/imgs/2.jpg"/>
			<img src="/themes/simplebootx_mobile/Zt/20190712/imgs/3.jpg"/>
			<div class="container pb-3 pt-3 gif-bg border-right">
				<img src="/themes/simplebootx_mobile/Zt/20190712/imgs/gif.gif"/>
			</div>
			<img src="/themes/simplebootx_mobile/Zt/20190712/imgs/4.jpg"/>
			<img src="/themes/simplebootx_mobile/Zt/20190712/imgs/5.jpg"/>
			<img src="/themes/simplebootx_mobile/Zt/20190712/imgs/6.jpg"/>
		</div>
		<div class="position-relative container pb-5 swiper-bg border-right">
			<div class="swiper-container">
					<div class="swiper-wrapper">
						<div class="swiper-slide"><img src="/themes/simplebootx_mobile/Zt/20190712/imgs/6-1.png"></div>
						<div class="swiper-slide"><img src="/themes/simplebootx_mobile/Zt/20190712/imgs/6-2.png"></div>
						<div class="swiper-slide"><img src="/themes/simplebootx_mobile/Zt/20190712/imgs/6-3.png"></div>
						<div class="swiper-slide"><img src="/themes/simplebootx_mobile/Zt/20190712/imgs/6-4.png"></div>
					</div>
				</div>
	...
	<div class="copy pb-0 border-right">
