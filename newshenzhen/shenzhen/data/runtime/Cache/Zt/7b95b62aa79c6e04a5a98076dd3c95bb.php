...
<html>
	<head>
	<meta charset="UTF-8">
	<title>缺牙的解决办法_<?php echo ($site_name); ?></title>
...
<script language="javascript" src="http://swt.szddkqyy.com/JS/LsJS.aspx?siteid=MTI57225838&lng=cn"></script>
	...
	<link href="/themes/simplebootx_mobile/Zt/20190430/index.css" rel="stylesheet" type="text/css">
...
<script>
	...
	<body>
		<section class=" gotoform"><img src="/themes/simplebootx_mobile/Zt/20190430/imgs/1.jpg" /></section>
	
	<section class="container pb-2">
		<form action="" class="mt-3 mb-4">
			<div class="symptom mb-3">
				<font class="d-inline-block pt-2 pb-2 mr-2 mb-2 active">缺大牙/门牙</font>
			...
			<input type="text" class="w-100 pt-2 pb-2 name" name="data[name]" placeholder="姓名">
			<input type="text" class="w-100 pt-2 pb-2 mt-2 phone"  name="data[phone]" placeholder="电话">
		...
		<p class="text-center pt-2 mb-3">
			<a href="javascript:;" class="text-center text-white w-75 submit-btn pt-2 pb-2 d-inline-block">申请院长亲诊名额</a>
		</p>
	</section>
	<div class="">
		<img src="/themes/simplebootx_mobile/Zt/20190430/imgs/2.jpg"/>
		<img src="/themes/simplebootx_mobile/Zt/20190430/imgs/3.jpg"/>
		<img src="/themes/simplebootx_mobile/Zt/20190430/imgs/4.jpg"/>
	</div>
	...
	<section class="fixed fixed-bottom fixed-btn text-center">
		<a href="/swt/"><img class="position-absolute fixed-btn2 mr-3" src="/themes/simplebootx_mobile/Zt/20190430/imgs/fixed.png"/>
		<img class="position-absolute fixed-btn3 " src="/themes/simplebootx_mobile/Zt/20190430/imgs/fixed-btn.png" /></a>
	</section>
	</body>
