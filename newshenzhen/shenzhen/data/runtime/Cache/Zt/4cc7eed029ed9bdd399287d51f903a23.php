...
<head>
	<meta charset="UTF-8">
	<title><!--AI+即刻美3.0-->_<?php echo ($site_name); ?></title>
	<head>
...
<script language="javascript" src="http://swt.szddkqyy.com/JS/LsJS.aspx?siteid=MTI57225838&lng=cn"></script>
	...
	<link href="/themes/simplebootx/Zt/jkm/index.css" rel="stylesheet" type="text/css">
	<script src="/themes/simplebootx/Public/js/swiper.min.js"></script>
</head>
<body>
	<header class="header">
...
<script>
	...
	<section class="banner text-center"><img src="/themes/simplebootx/Zt/jkm/imgs/banner.jpg" alt="" class="img-fluid"></section>

	<section class="content-box-1 pt-5 pb-5">
		<div class="container">
			<div class="content-title text-center">
				<h3 class="red position-relative"><span class="position-relative">01</span></h3>
				<h1 class="red d-inline-block">牙齿美观有多重要？</h1>
			</div>
			<div class="row mt-5">
				<div class="col-md-6"><img src="/themes/simplebootx/Zt/jkm/imgs/content-1.png" alt=""></div>
				<div class="col-md-6">
					<h2 class="mb-5 mt-4">
						<span class="red">43%</span>
						的人表示在与人交谈时, 首先关注的面部区域是
						<span class="red">牙齿</span>
					</h2>
					<p class="content-1-text mb-5">健康、迷人的笑容对别人的影响比你想象的更重要，而牙齿问题<span class="red">（色素牙、氟斑牙、牙齿稀疏等）</span>是影响面部美观的重要因素。</p>
					<a href="/swt" target="_blank" class="swt-btn lead text-white text-center">在线咨询我的牙齿问题</a>
				</div>
			</div>
		</div>
	</section>

	<section class="content-box-2 pt-5">
		<div class="content-title text-center">
			<h3 class="red position-relative"><span class="position-relative">02</span></h3>
			<h1 class="d-inline-block"><!--AI+即刻美3.0<span class="red">重塑你的迷人笑容--></span></h1>
		</div>
		<div class="mt-5 position-relative">
			<div class="d-flex">
				<div class="w-50"><img src="/themes/simplebootx/Zt/jkm/imgs/content-2-1-0.jpg"></div>
				<div class="w-50">
					<!-- <video src="/themes/simplebootx/Zt/jkm/jikemei.mp4" width="100%" controls="controls"></video> -->
					<img src="/themes/simplebootx/Zt/jkm/imgs/1.png" alt="">
				</div>
			</div>
			<div class="content-banner">
				<div class="content-banner-show">
					<div class="d-flex">
						<div class="w-50"><img src="/themes/simplebootx/Zt/jkm/imgs/content-2-1-2.jpg" alt="" class="img-fluid"></div>
						<div class="w-50"><img src="/themes/simplebootx/Zt/jkm/imgs/content-2-1-3.jpg" alt="" class="img-fluid"></div>
					</div>
				</div>
				<div class="unshow">
					<div class="d-flex">
						<div class="w-50"><img src="/themes/simplebootx/Zt/jkm/imgs/content-2-2-2.jpg" alt="" class="img-fluid"></div>
						<div class="w-50"><img src="/themes/simplebootx/Zt/jkm/imgs/content-2-2-3.jpg" alt="" class="img-fluid"></div>
					</div>
				</div>
				<div class="unshow">
					<div class="d-flex">
						<div class="w-50"><img src="/themes/simplebootx/Zt/jkm/imgs/content-2-3-2.jpg" alt="" class="img-fluid"></div>
						<div class="w-50"><img src="/themes/simplebootx/Zt/jkm/imgs/content-2-3-3.jpg" alt="" class="img-fluid"></div>
					</div>
				</div>
				<div class="unshow">
					<div class="d-flex">
						<div class="w-50"><img src="/themes/simplebootx/Zt/jkm/imgs/content-2-4-2.jpg" alt="" class="img-fluid"></div>
						<div class="w-50"><img src="/themes/simplebootx/Zt/jkm/imgs/content-2-4-3.jpg" alt="" class="img-fluid"></div>
					</div>
				</div>
			</div>
			<div class="content-banner-btn position-absolute d-flex">
				<a href="javascript:;" class="arrow-left"><i class="arrow"></i></a>
				<a href="javascript:;" class="arrow-right"><i class="arrow"></i></a>
			</div>
		</div>
	</section>

	<section class="content-box-3 pt-5">
		<div class="container pt-5 position-relative">
			<div class="d-flex">
				<div class="swiper-container doctor col-md-9 p-0">
					<div class="swiper-wrapper">
						<div class="d-flex swiper-slide">
							<div class="col-md-4 pt-3">
								<h1 class="red">王平昊</h1>
								<p class="job pb-3">主治医师  |  即刻美推广专家</p>
								<h3 class="mt-4">擅长项目</h3>
								<p class="mb-5">龋齿预防和树脂修补治疗、根管治疗、牙周病治疗、各种烤瓷冠、烤瓷桥修复、活动义齿的修复、常规牙拔除术</p>
								<a href="/swt" target="_blank" class="swt-btn text-center text-white">立即预约</a>
							</div>
							<div class="col-md-8"><img src="/themes/simplebootx/Zt/jkm/imgs/content-3-doctor-6.png" alt=""></div>
						</div>
					</div>
				</div>
				<div class="col-md-3 text-center doctor-msg-right content-title">
					<h3 class="red position-relative"><span class="position-relative">03</span></h3>
					<h4><!--AI+即刻美3.0--></h4>
					<h4 class="red">只选专业医生</h4>
				</div>
				<div class="row doctor-tab position-absolute">
					<div class="w-30 pt-3 pb-3">
						<div class="d-flex pt-3 pb-3 pl-2 pr-2">
							<div class="w-50">
								<img src="/themes/simplebootx/Zt/jkm/imgs/doctor-tab-list-6.png" alt="">					
							</div>
							<div class="w-50 pl-2">
								<h4 class="mb-2">王平昊</h4>
								<p class="mb-0">即刻美推广专家</p>
							</div>
						</div>
					</div>
				</div>
	...
	<section class="content-box-4 pt-5">
		<div class="container">
			<div class="content-title text-center">
				<h3 class="red position-relative"><span class="position-relative">04</span></h3>
				<h1 class="d-inline-block"><!--AI+即刻美3.0--><span class="red">真人案例</span></h1>
				<p class="red">美白牙齿，让她们的美丽升级</p>
			</div>
			<div class="row mt-5">
				<div class="col-md-4">
					<p><img src="/themes/simplebootx/Zt/jkm/imgs/before-after-1.jpg" alt=""></p>
					<p>黄牙美白前后</p>
				</div>
				<div class="col-md-4">
					<p><img src="/themes/simplebootx/Zt/jkm/imgs/before-after-2.jpg" alt=""></p>
					<p>氟斑牙美白前后</p>
				</div>
				<div class="col-md-4">
					<p><img src="/themes/simplebootx/Zt/jkm/imgs/before-after-3.jpg" alt=""></p>
					<p>四环素牙美白前后</p>
				</div>
				<div class="col-md-4">
					<p><img src="/themes/simplebootx/Zt/jkm/imgs/before-after-4.jpg" alt=""></p>
					<p>龋齿修复前后</p>
				</div>
				<div class="col-md-4">
					<p><img src="/themes/simplebootx/Zt/jkm/imgs/before-after-5.jpg" alt=""></p>
					<p>门牙稀疏修复前后</p>
				</div>
				<div class="col-md-4">
					<p><img src="/themes/simplebootx/Zt/jkm/imgs/before-after-6.jpg" alt=""></p>
					<p>牙间间隙修复前后</p>
				</div>
				<div class="col-md-4">
					<p><img src="/themes/simplebootx/Zt/jkm/imgs/before-after-7.jpg" alt=""></p>
					<p>烟渍牙美白前后</p>
				</div>
				<div class="col-md-4">
					<p><img src="/themes/simplebootx/Zt/jkm/imgs/before-after-8.jpg" alt=""></p>
					<p>牙齿缺损修复前后</p>
				</div>
				<div class="col-md-4">
					<p><img src="/themes/simplebootx/Zt/jkm/imgs/before-after-9.jpg" alt=""></p>
					<p>牙齿不齐修复前后</p>
				</div>
			</div>
			<div class="text-center mt-5">
				<a href="/swt" target="_blank" class="swt-btn lead text-white text-center">在线定制我的修复方案</a>
			</div>
		</div>
	</section>

	<section class="content-last mt-5 text-center"><img src="/themes/simplebootx/Zt/jkm/imgs/content-last.jpg" alt="" class="img-fluid"></section>
...
<script src="/themes/simplebootx/Zt/jkm/index.js"></script>
</html>