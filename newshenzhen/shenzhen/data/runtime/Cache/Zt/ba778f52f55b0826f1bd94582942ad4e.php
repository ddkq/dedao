...
<head>
	<meta charset="UTF-8">
	<title>深圳缺牙市民申领种牙方案_<?php echo ($site_name); ?></title>
...
<script language="javascript" src="http://swt.szddkqyy.com/JS/LsJS.aspx?siteid=MTI57225838&lng=cn"></script>
	...
	<link href="/themes/simplebootx_mobile/Zt/20181217/index.css" rel="stylesheet" type="text/css">
...
<body>
	...
	<section class=""><img src="/themes/simplebootx_mobile/Zt/20181217/imgs/1.jpg" alt=""></section>

	<section class="container pt-3 pb-3 content-form">
		<form action="">
			<p class="mb-1">我的牙齿状况：</p>
			<span class="d-inline-block w-31">
				<input type="radio" class="mr-1" name="data[symptom]" value="缺门牙" id="radio-2" checked="checked">
				<label for="radio-2">缺门牙</label>
			</span>
			<span class="d-inline-block w-31">
				<input type="radio" class="mr-1" name="data[symptom]" value="缺大牙" id="radio-1">
			...
			<span class="d-inline-block">
				<input type="radio" class="mr-1" name="data[symptom]" value="常年佩戴假牙/义齿" id="radio-6">
				<label for="radio-6">常年佩戴假牙/义齿</label>
			</span>
			...
			<p class="mb-1">我的年龄：</p>
			<span class="d-inline-block w-31">
				<input type="radio" class="mr-1" name="data[age]" value="30岁以下" id="radio-8" checked="checked">
				<label for="radio-8">30岁以下</label>
			</span>
			<span class="d-inline-block w-31">
				<input type="radio" class="mr-1" name="data[age]" value="40-50岁" id="radio-9">
				<label for="radio-9">40-50岁</label>
			</span>
			<span class="d-inline-block w-31">
				<input type="radio" class="mr-1" name="data[age]" value="50-60岁" id="radio-10">
				<label for="radio-3">50-60岁</label>
			</span>
			<span class="d-inline-block w-31">
				<input type="radio" class="mr-1" name="data[age]" value="70岁以上" id="radio-11">
				<label for="radio-4">70岁以上</label>
			</span>
		...
		<p class="text-center"><a href="javascript:;" class="submit-btn d-block pt-2 pb-2 mt-4 text-white">提交-领取补贴</a></p>
	</section>

	<section>
		<img src="/themes/simplebootx_mobile/Zt/20181217/imgs/2.jpg" alt="">
		<img src="/themes/simplebootx_mobile/Zt/20181217/imgs/3.jpg" alt="">
		<img src="/themes/simplebootx_mobile/Zt/20181217/imgs/4.jpg" alt="">
		<img src="/themes/simplebootx_mobile/Zt/20181217/imgs/5.jpg" alt="">
		<img src="/themes/simplebootx_mobile/Zt/20181217/imgs/6.jpg" alt="">
	</section>
	
	<section class="container" >
		<div class="swiper-container swiper01">
			<div class="swiper-wrapper">
				<div class="swiper-slide"><img src="/themes/simplebootx_mobile/Zt/20181217/imgs/6-1.jpg" alt=""></div>
				<div class="swiper-slide"><img src="/themes/simplebootx_mobile/Zt/20181217/imgs/6-2.jpg" alt=""></div>
			</div>
		</div>
		<div class="swiper-pagination1 text-center"></div>
		<div class="swiper-container swiper02 mt-3">
			<div class="swiper-wrapper">
				<div class="swiper-slide"><img src="/themes/simplebootx_mobile/Zt/20181217/imgs/6-3.jpg" alt=""></div>
				<div class="swiper-slide"><img src="/themes/simplebootx_mobile/Zt/20181217/imgs/6-4.jpg" alt=""></div>
			</div>
		</div>
	...
	<img src="/themes/simplebootx_mobile/Zt/20181217/imgs/7.png" alt="">
