...
$configs= array(
        ...
        'MODULE_ALLOW_LIST'  => array('Admin','Portal','Asset','Api','User','Wx','Comment','Qiushi','Tpl','Topic','Install','Bug','Better','Pay','Cas','Qa','Experience','Encyclopedia','Department','Goods','Zt','Job','Swt','Tables','Questionnaire','Award','Topic'),
        ...
        'SP_DEFAULT_THEME_PHONE'=> 'simplebootx_mobile',// 前台模板文件（手机）
		...
		'MAIL_USERNAME' =>'webadmin@gzcells.com',//你的邮箱名
		'MAIL_FROM' =>'webadmin@gzcells.com',//发件人地址
		'MAIL_FROMNAME'=>'webadmin@gzcells.com',//发件人姓名
		'MAIL_PASSWORD' =>'web123',//邮箱密码
		'MAIL_PORT' => '465',//端口号
		'MAIL_TO'=>'798354597@qq.com',//收件人地址
