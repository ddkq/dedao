	...
	$('.header-nav-list li').on('mouseleave', function() {
		...
		<div class="main_content clearfix">
			<div class="LEFT">
				...
				<a class="media list_recommend" href="<?php echo get_article_url($gr_recommend[tid],$gr_recommend[link_type],$gr_recommend[post_url]);?>">
					<div class="media-left media-middle">
						<img class="media-object" src="<?php echo ($gr_recommend['smeta']['thumb']); ?>" >
					</div>
					<div class="media-body">
						<h4 class="media-heading"><?php echo ($gr_recommend["post_title"]); ?></h4>
						<p><?php echo mb_substr($gr_recommend[post_excerpt],0,90,'utf-8');?></p>
					</div>
				</a>
