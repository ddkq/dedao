<?php if (!defined('THINK_PATH')) exit();?><!--院内环境-->
<!DOCTYPE html>
<html>
	<head>
	...
	<div class="brand_left_bd">
		<ul>
			...
			<div class="brand_right">
				...
				<div class="brand_hj_info"><?php echo ($post_content); ?></div>
				<div class="brand_hj_tab">
					<div class="brand-hj-focus">
						<div class="fbd">
							<ul>
								<li><img src="/themes/simplebootx/Public/images/environment/lh1.jpg" alt=""></li>
								<li><img src="/themes/simplebootx/Public/images/environment/lh2.jpg" alt=""></li>
								<li><img src="/themes/simplebootx/Public/images/environment/lh3.jpg" alt=""></li>
								<li><img src="/themes/simplebootx/Public/images/environment/lh4.jpg" alt=""></li>
								<li><img src="/themes/simplebootx/Public/images/environment/lh5.jpg" alt=""></li>
							</ul>
						</div>
						<div class="fhd">
							<a href="javascript:;" target="_self" class="fprev"></a>
							<a href="javascript:;" target="_self" class="fnext"></a>
							<div class="fhd_box">
								<ul class="clearfix">
									<li class="on"><img src="/themes/simplebootx/Public/images/environment/lh1.jpg" alt=""></li>
									<li><img src="/themes/simplebootx/Public/images/environment/lh2.jpg" alt=""></li>
									<li><img src="/themes/simplebootx/Public/images/environment/lh3.jpg" alt=""></li>
									<li><img src="/themes/simplebootx/Public/images/environment/lh4.jpg" alt=""></li>
									<li><img src="/themes/simplebootx/Public/images/environment/lh5.jpg" alt=""></li>
	...
	<script>
		$('.brand-hj-focus').slide({
	        ...
	        startFun: function (i, c,s) {
	            var $fhdUl = $(s).find('.fhd ul'),
	                hdliWidth = $fhdUl.find('li').outerWidth()  + 3;
				var rnum = 4;  //当前选中的图片右边还有几张图片
				if(i<rnum){
					$fhdUl.stop().animate({'left': '0px'},500);
				}
				else if(i + rnum < c){
					$fhdUl.stop().animate({'left': - (i-rnum) * hdliWidth + 'px'},500);
				}else{
					$fhdUl.stop().animate({'left': - (c-rnum-1) * hdliWidth + 'px'},500);
				}	
	        }
	    });
	</script>
