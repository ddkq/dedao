...
<html>
	<head>
	<meta charset="UTF-8">
	<title>父亲节种牙补贴_<?php echo ($site_name); ?></title>
...
<script language="javascript" src="http://swt.szddkqyy.com/JS/LsJS.aspx?siteid=MTI57225838&lng=cn"></script>
	...
	<link href="/themes/simplebootx_mobile/Zt/20190522/index.css" rel="stylesheet" type="text/css">
...
<script>
	...
	<body>
	<section class=""><img src="/themes/simplebootx_mobile/Zt/20190522/imgs/1.jpg" /></section>
		...
		<form action="" class="mt-3 mb-4">
			<div class="symptom mb-3">
				...
				<font class="d-inline-block pt-2 pb-2 mr-1 mb-2 ">久戴假牙</font>
				<font class="d-inline-block pt-2 pb-2 mr-1 mb-2 ">半口缺牙</font>
				<font class="d-inline-block pt-2 pb-2 mr-1 mb-2 ">全口缺牙</font>
				<font class="d-inline-block pt-2 pb-2 mr-1 mb-2 ">其他牙齿问题</font>
	...
	<div class="">
		<img src="/themes/simplebootx_mobile/Zt/20190522/imgs/3.jpg"/>
		<img src="/themes/simplebootx_mobile/Zt/20190522/imgs/4.jpg"/>
		<img src="/themes/simplebootx_mobile/Zt/20190522/imgs/5.jpg"/>
		<img src="/themes/simplebootx_mobile/Zt/20190522/imgs/6.jpg"/>
		<img src="/themes/simplebootx_mobile/Zt/20190522/imgs/7.jpg"/>
		<div class="container"><img src="/themes/simplebootx_mobile/Zt/20190522/imgs/7.gif"/></div>
		<img src="/themes/simplebootx_mobile/Zt/20190522/imgs/8.jpg"/>
	</div>
	
	<section>
		
		<div class="content-bg container swiper01 pb-3">
			<div class="p-3"><img src="/themes/simplebootx_mobile/Zt/20190522/imgs/title.png"/></div>
			<div class="swiper-container mt-2">
				<div class="swiper-wrapper">
					<div class="swiper-slide"><img src="/themes/simplebootx_mobile/Zt/20190522/imgs/swiper-1.png" alt=""></div>
					<div class="swiper-slide"><img src="/themes/simplebootx_mobile/Zt/20190522/imgs/swiper-2.png" alt=""></div>
					<div class="swiper-slide"><img src="/themes/simplebootx_mobile/Zt/20190522/imgs/swiper-3.png" alt=""></div>
					<div class="swiper-slide"><img src="/themes/simplebootx_mobile/Zt/20190522/imgs/swiper-4.png" alt=""></div>
				</div>
			</div>
