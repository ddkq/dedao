...
<script language="javascript" src="http://swt.szddkqyy.com/JS/LsJS.aspx?siteid=MTI57225838&lng=cn"></script>
	...
	<link rel="stylesheet" href="/themes/simplebootx/Zt/zzyrzds/special.css">
</head>
<body>
	<header class="header">
...
<script>
	...
	<section>
		<div class="banner center"><img src="/themes/simplebootx/Zt/zzyrzds/images/banner.jpg" alt=""></div>
		<div class="b-img-box"><img src="/themes/simplebootx/Zt/zzyrzds/images/b-img.png" alt=""></div>
	</section>
	<section class="width">
		<div class="activityBcg">
			<div class="activity-left">
				<h1>活动</h1>
				<p><span>背景</span></p>
				<p>activity <br> background</p>
			</div>
			<div class="activity-msg">2016年3月，当人工智能阿尔法狗击败围棋世界冠军李世石时，整个世界为之震惊，这标志着人工智能的强势崛起。然而，似乎对于口腔行业的影响很小，“AI+医疗”的概念虽已被大多数人知晓，但由于医疗的特殊性等种种原因，许多的研究仍在停留在实验室阶段，还未进入到临床普及。口腔行业更是如此，这个极其重要又总是被忽视的领域，仍基本停留在完全依靠医生经验的传统种植牙阶段。9月，深圳迎来中国口腔行业人类与AI最早的口腔领域的对决——“中国口腔行业2018种植牙人机大赛”，大赛以实验性质来验证“AI+口腔”的应用和价值，以成果和经验来推动中国口腔产业的升级。同时，大赛悬赏100万元现金向社会征集100名高难种植病例，入选市民不仅可获得部分高难种植牙专项补贴，还可以得到国内外种植牙专家的治疗。</div>
		</div>
	</section>
	<section>
		<div class="center"><img src="/themes/simplebootx/Zt/zzyrzds/images/content1.jpg" alt=""></div>
	</section>
	<section class="width" style="margin-bottom: 20px;">
		<div class="center">
			<div class="doctor-title">
				<h1>3国6城口腔医学顶级力量 9月汇聚中国深圳</h1>
				<p class="doctor-title-text">Dental implant authoritative expert</p>
			</div>
			<p class="doctor-text">届时，来自3个国家6个城市的口腔领域顶尖的专家、学者、医生代表将出席大赛，共同见证这场极具实用价值与产业推动意义的大赛！</p>
		</div>
		<ul class="flex doctor-list">
			<li>
				<div>
					<div class="doctor-img-box"><img src="/themes/simplebootx/Zt/zzyrzds/images/doctor2.jpg" alt=""></div>
					<div class="doctor-msg">
						<p class="doctor-name">李建君</p>
						<p class="doctor-position">深圳德道口腔院长<span>中国·深圳</span></p>
					</div> 
					<div class="doctor-detail">
						<h1 class="doctor-name">李建君</h1> 
						<div> 
							<p>北京即刻用种植牙研究院成员</p>
							<p>国际植牙医学会会员</p> 
							<p>瑞典诺贝尔北京地区培训导师</p>
						...
						<p class="doctor-btn"><a href="/swt/" target="_blank">我要预约</a></p> 
					</div>
				</div>
			</li>
			<li>
				<div>
					<div class="doctor-img-box"><img src="/themes/simplebootx/Zt/zzyrzds/images/doctor1.jpg" alt=""></div>
					<div class="doctor-msg">
						<p class="doctor-name">罗君</p>
						<p class="doctor-position">成都德道口腔院长<span>中国·成都</span></p>
					</div> 
					<div class="doctor-detail">
						<h1 class="doctor-name">罗君</h1> 
						<div> 
							<p>诺贝尔种植体中国区讲师</p>
							<p>德国ICX植体特聘研究员</p> 
						</div>
			...
			<li>
				<div>
					<div class="doctor-img-box"><img src="/themes/simplebootx/Zt/zzyrzds/images/doctor8.jpg" alt=""></div>
					<div class="doctor-msg">
						<p class="doctor-name">蔡明河</p>
						<p class="doctor-position">成都德道口腔副院长<span>中国·成都</span></p>
					</div> 
					<div class="doctor-detail"> 
						<h1 class="doctor-name">蔡明河</h1> 
						<div>
							<p>河南医科大学口腔医学硕士</p> 
							<p>河南省医院管理协会口腔分会常委</p>
							<p>河南省抗癌协会头颈专业委员会委员</p>
							<p>“即刻用”高难种植牙领域领军人物</p>
						</div>
						<p class="doctor-btn"><a href="/swt/" target="_blank">我要预约</a></p> 
					</div>
		...
		<ul class="flex doctor-list">
			<li>
				<div>
					<div class="doctor-img-box"><img src="/themes/simplebootx/Zt/zzyrzds/images/doctor5.jpg" alt=""></div>
					<div class="doctor-msg">
						<p class="doctor-name">亚历山大• 赫登</p>
						<p class="doctor-position">生命科学博士<span>德国</span></p>
					</div> 
					<div class="doctor-detail">
						<h1 class="doctor-name">亚历山大• 赫登</h1> 
						<div> 
							<p>种植体材料专家</p>
							<p>ICX种植体研发管理专家</p> 
			...
			<li>
				<div>
					<div class="doctor-img-box"><img src="/themes/simplebootx/Zt/zzyrzds/images/doctor6.jpg" alt=""></div>
					<div class="doctor-msg">
						<p class="doctor-name">克劳迪奥•索尔迪尼</p>
						<p class="doctor-position">帕多瓦大学牙周病学高级教授<span>意大利</span></p>
					</div> 
					<div class="doctor-detail">
						<h1 class="doctor-name">克劳迪奥•索尔迪尼</h1> 
						<div> 
			...
			<li>
				<div>
					<div class="doctor-img-box"><img src="/themes/simplebootx/Zt/zzyrzds/images/doctor7.jpg" alt=""></div>
					<div class="doctor-msg">
						<p class="doctor-name">费德里科• 比安奇</p>
						<p class="doctor-position">米兰大学牙科学博士<span>意大利</span></p>
					</div> 
					<div class="doctor-detail">
						<h1 class="doctor-name">费德里科• 比安奇</h1> 
						<div> 
	...
	<section style="background: #0B1250;">
		<div class="center">
			...
			<p class="media-text">此次大赛特邀南方都市报、深圳晚报、深圳特区报、晶报、网易新闻、今日头条等权威主流媒体全程跟踪报道，并在此盛情邀约广大市民一起共同见证智能牙科的技术创新成果，这是技术创新的一小步，却是中国口腔的一大步。</p>
		</div>
		<ul class="flex width media-logo">
			<li><img src="/themes/simplebootx/Zt/zzyrzds/images/media1.jpg" alt=""></li>
			<li><img src="/themes/simplebootx/Zt/zzyrzds/images/media2.jpg" alt=""></li>
			<li><img src="/themes/simplebootx/Zt/zzyrzds/images/media3.jpg" alt=""></li>
			<li><img src="/themes/simplebootx/Zt/zzyrzds/images/media4.jpg" alt=""></li>
			<li><img src="/themes/simplebootx/Zt/zzyrzds/images/media5.jpg" alt=""></li>
			<li><img src="/themes/simplebootx/Zt/zzyrzds/images/media6.jpg" alt=""></li>
		</ul>
	</section>
		...
		<div class="section6-content flex">
			...
			<div class="section6-content-right flex">
				<form id="form1" method="post" enctype="multipart/form-data">
					...
					<div class="section6-input-text" style="margin-top: 0;">
						<p class="must">您的症状：</p>
...
<script>
	...
	$('.doctor-list li').on('mouseleave', function() {
		$(this).children().children('.doctor-msg').css('opacity', 1);
		$(this).children().children('.doctor-detail').css({'top': '100%', 'opacity': 0});
	})
