...
<body>
	...
	<section class=""><img src="/themes/simplebootx_mobile/Zt/20190225/imgs/1-1.jpg" alt=""></section>
	<section class="container">
		<form action="" class="mt-3 mb-4">
			<div class="symptom">
				...
				<font class="d-inline-block pt-2 pb-2 mr-2 mb-2 ">缺门牙/大牙</font>
		...
		<p class="text-center font-14">———距离截止时间，还剩———</p>
		<div class="position-relative">
			...
			<p class="text-center number text-white position-relative">已有<?php echo ($code = mt_rand(300,500)); ?>人报名</p>
	...
	<div class="mt-2">
		<img src="/themes/simplebootx_mobile/Zt/20190225/imgs/2-1.jpg" alt="">
		<img src="/themes/simplebootx_mobile/Zt/20190225/imgs/3.jpg" alt="">
		<img src="/themes/simplebootx_mobile/Zt/20190225/imgs/4.jpg" alt="">
		<img src="/themes/simplebootx_mobile/Zt/20190225/imgs/5.jpg" alt="">
		<img src="/themes/simplebootx_mobile/Zt/20190225/imgs/6.jpg" alt="">
		<img src="/themes/simplebootx_mobile/Zt/20190225/imgs/7.jpg" alt="">
		<img src="/themes/simplebootx_mobile/Zt/20190225/imgs/8.jpg" alt="">
	</div>
	
	<div class="copy pb-5" style="background: #6d1000;">
	...
	<div class="fixed fixed-bottom"><img src="/themes/simplebootx_mobile/Zt/20190225/imgs/phone.png" /></div>
</body>
<script>
	$(function() {
