...
<script language="javascript" src="http://swt.szddkqyy.com/JS/LsJS.aspx?siteid=MTI57225838&lng=cn"></script>
	<title><!--德道AI+即刻正3.0-->_<?php echo ($site_seo_title); ?></title>
	<meta name="keywords" content="<?php echo ($site_seo_keywords); ?>" />
	<meta name="description" content="<?php echo ($site_seo_description); ?>" />
	<link rel="stylesheet" href="/themes/simplebootx/Zt/jkz/css/bootstrap4.min.css">
	<link rel="stylesheet" href="/themes/simplebootx/Zt/jkz/css/new-index.css">
</head>
<body>
	<header class="header">
...
<script>
	...
	<section class="content-box-1 text-center">
		<img src="/themes/simplebootx/Zt/jkz/imgs/banner.jpg" alt="">
	</section>
	
	<section class="content-box-2 container">
		<div class="row">
			<div class="col-md-12 mt-5 mb-5">
				<h1 class="content-title text-center"><span><!-->AI+即刻正3.0--></span>精准解决各种牙齿不齐问题</h1>
			</div>
		</div>
		<ul class="content-list d-flex text-center justify-content-between mb-5">
			<li class="w-16 pt-3">
				<a href="/list/6.html">
	...
	<section class="content-box-3">
		<div class="container pb-5">
			<div class="row">
				<div class="col-md-12 mt-5 mb-5">
					<h1 class="content-title text-center">一个有<span>预知能力</span>的技术</h1>
				</div>
			</div>
			<div class="row">
				<div class="col-md-12 position-relative mb-5">
					<div class="text-center"><img src="/themes/simplebootx/Zt/jkz/imgs/006DL.gif" style="width:81%;"></div>
					<a href="/swt" target="_blank" class="content-btn text-white pt-3 pb-3 pl-5 pr-5 lead position-absolute text-center">我要改变自己</a>
				</div>
			</div>
		</div>
	</section>
		...
		<div class="container pb-5">
			<div class="row">
				<div class="col-md-12 mt-5 mb-4">
					<h1 class="content-title text-center"><span><!--德道AI+美学正畸--></span>——让你从“齿”高颜值</h1>
				</div>
			</div>
			<div class="w-100 text-center mb-5 content-text">以人工智能技术为核心，将数字化与正畸技术深度结合，让经验模式诊疗走向数字化精准诊疗，<br>将齿科正畸美学+全数字化科技+口腔美容+东方人的脸型结构作为口腔审美的重要课题，融入德国CT靶向定位正畸技术，<br>通过口腔CT-3维立体重建定位正畸方向及角度，针对东方人的口腔环境、牙齿、牙骨特性精研而成。</div>
			<div class="row content-img-box p-5">
				<div class="col-md-5"><img src="/themes/simplebootx/Zt/jkz/imgs/content-box-4-01.jpg" alt=""></div>
				<div class="col-md-7">
					<div><img src="/themes/simplebootx/Zt/jkz/imgs/content-box-4-02.jpg" alt=""></div>
					<div class="mt-5 content-text"><!--德道AI+美学正畸，能够根据不同的正畸难度，在设计牙齿矫正方案时，不仅考虑咬合关系，更综合了现代颜面美学关于门牙及牙龈露的程度、笑线等口内外综合数据，实现在矫正牙齿的同时，重塑美丽笑线和脸型。--></div>
				</div>
			</div>
		</div>
	</section>

	<section class="content-box-5">
		<div class="container text-white pb-5">
			<div class="row">
				<div class="col-md-12 mt-5 mb-5">
					<div class="content-title text-center">
						<h1><!--德道AI+即刻正3.0四大优势--></h1>
					</div>
				</div>
			</div>
			<ul class="d-flex flex-md-wrap justify-content-between">
				<li class="w-49 d-flex justify-content-between">
					<div class="text-right">
						<h2 class="mt-3">术前预知效果</h2>
						<p class="mt-3">在矫治开始前即可在计算机上模拟显示整个矫治<br>过程中患者牙颌的变化过程，实现了矫治过程的<br>效果预测，有利于医患交流。</p>
					</div>
					<div><i class="index-icon"></i></div>
				</li>
				<li class="w-49 d-flex justify-content-between">
					<div><i class="index-icon"></i></div>
					<div>
						<h2 class="mt-3 pl-3">数字化技术和设备</h2>
						<p class="mt-3 pl-3">全程采用国际数字化先进精密设备，矫治过程精准定位，并根据每个人的五官和脸型特征，塑造个性化的牙齿微笑曲线。</p>
					</div>
				</li>
				<li class="w-49 mt-2 d-flex justify-content-between">
					<div class="text-right">
						<h2 class="mt-3">专家会诊制度</h2>
						<p class="mt-3">院内专家团队对疑难病例进行会诊，商讨方案，<br>目的是让患者的情况更快明晰，更能规避风险，<br>治疗更恰当有效。</p>
					</div>
					<div><i class="index-icon"></i></div>
				</li>
				<li class="w-49 mt-2 d-flex justify-content-between">
					<div><i class="index-icon"></i></div>
					<div>
						<h2 class="mt-3 pl-3">正畸大数据库</h2>
						<p class="mt-3 pl-3">在矫治开始前即可在计算机上模拟显示整个矫治过程中患者牙颌的变化过程，实现了矫治过程的效果预测，有利于医患交流。</p>
					</div>
				</li>
			</ul>
		</div>
	...
	<section class="content-box-6">
		<div class="container">
			<div class="row">
				<div class="col-md-12 mt-5 mb-5">
					<div class="content-title text-center">
						<h1><span>牙齿矫正</span>对一个人的外貌变化有多大影响？</h1>
					</div>
				</div>
			</div>
			<div class="row">
				<div class="col-md-4"><img src="/themes/simplebootx/Zt/jkz/imgs/content-box-6-01.jpg" alt=""></div>
				<div class="col-md-4"><img src="/themes/simplebootx/Zt/jkz/imgs/content-box-6-02.jpg" alt=""></div>
				<div class="col-md-4"><img src="/themes/simplebootx/Zt/jkz/imgs/content-box-6-03.jpg" alt=""></div>
			</div>
			<div class="row mt-4">
				<div class="col-md-6"><img src="/themes/simplebootx/Zt/jkz/imgs/content-box-6-04.jpg" alt=""></div>
				<div class="col-md-6"><img src="/themes/simplebootx/Zt/jkz/imgs/content-box-6-05.jpg" alt=""></div>
			</div>
			<div class="row mt-5 mb-5">
				<div class="col-md-12 text-center"><a href="/swt/" target="_blank" class="content-btn text-white pt-3 pb-3 pl-4 pr-4 lead">我想和他们一样</a></div>
			</div>
		</div>
	</section>
	
	<section class="content-box-7">
		<div class="container pb-5 position-relative">
			<div class="row">
				<div class="col-md-12 mt-5 mb-4">
					<div class="content-title text-center">
						<h1><span>做正畸</span>选对医生很重要</h1> </div>
				</div>
			</div>
			<div class="w-100 text-center pb-3 content-text">专业的事情交给专业的人来做</div>
			<div class="swiper-container content-box-7-banner">
				<ul class="doctor-banner text-white mt-5 mb-5 swiper-wrapper">
					<li class="d-flex swiper-slide">
						<div class="col-md-5">
							<div class="img-box position-absolute"><img src="/data/upload/20181106/5be16546477ea.png" alt=""></div>
						</div>
						<div class="text-left col-md-7 p-5">
							<h2>梅玉雯</h2>
							<ul class="mb-4">
								<li class="mb-1"><!--AI+即刻正推广专家--></li>
							</ul>
							<h4 class="mb-3">擅长项目</h4>
							<p>传统固定矫正、隐形矫正技术及儿童错颌的早期干预。</p>
							<div class="doctor-banner-btn">
								<a href="/swt/" target="_blank" class="pl-4 pr-4 pt-2 pb-2 mr-3"><i class="index-icon mr-2"></i>立即预约</a>
								<a href="/doctor/19.html" target="_blank" class="text-white pl-4 pr-4 pt-2 pb-2"><i class="index-icon mr-2"></i>查看详情</a>
							</div>
						</div>
					</li>
					<li class="d-flex swiper-slide">
						<div class="col-md-5">
							<div class="img-box position-absolute"><img src="/data/upload/20180912/5b98bc55a5703.png" alt=""></div>
						</div>
						<div class="text-left col-md-7 p-5">
							<h2>杨冬梅</h2>
							<ul class="mb-4">
							...
							<h4 class="mb-3">擅长项目</h4>
							<p>儿童及青少年早期预防性矫形治疗，成人固定矫正及无托槽隐形矫治技术，TWEED经典方丝弓矫治技术，肌功能矫形技术。</p>
							<div class="doctor-banner-btn">
								<a href="/swt/" target="_blank" class="pl-4 pr-4 pt-2 pb-2 mr-3"><i class="index-icon mr-2"></i>立即预约</a>
								<a href="/doctor/16.html" target="_blank" class="text-white pl-4 pr-4 pt-2 pb-2"><i class="index-icon mr-2"></i>查看详情</a>
							</div>
						</div>
					</li>
				</ul>
...
<script src="/themes/simplebootx/Zt/jkz/js/index.js"></script>
</html>