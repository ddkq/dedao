...
<head>
	<meta charset="UTF-8">
	<title>矫正牙齿瘦了脸也变美了？_<?php echo ($site_name); ?></title>
...
<script language="javascript" src="http://swt.szddkqyy.com/JS/LsJS.aspx?siteid=MTI57225838&lng=cn"></script>
	...
	<link href="/themes/simplebootx_mobile/Zt/20190307/index.css" rel="stylesheet" type="text/css">
...
<body>
	...
	<section class=""><img src="/themes/simplebootx_mobile/Zt/20190307/imgs/1.gif" alt=""></section>

	<section class="container">
		<form action="" class="mt-3 mb-4">
			<span class="d-inline-block w-31">
				<input type="radio" class="mr-1" name="data[symptom]" value="牙齿不齐" id="radio-1" checked="checked">
				<label for="radio-1">牙齿不齐</label>
			</span>
			<span class="d-inline-block w-31">
				<input type="radio" class="mr-1" name="data[symptom]" value="开颌" id="radio-2">
				<label for="radio-2">开颌</label>
			</span>
			<span class="d-inline-block w-31">
				<input type="radio" class="mr-1" name="data[symptom]" value="龅牙" id="radio-3">
				<label for="radio-3">龅牙</label>
			</span>
			<span class="d-inline-block w-31">
				<input type="radio" class="mr-1" name="data[symptom]" value="地包天" id="radio-4">
				<label for="radio-4">地包天</label>
			</span>
			<span class="d-inline-block w-31">
				<input type="radio" class="mr-1" name="data[symptom]" value="地包天" id="radio-5">
				<label for="radio-5">牙齿拥挤</label>
			</span>
		...
		<p class="text-center mb-0">———&nbsp;获奖名单如下&nbsp;———</p>
	...
	<div class="mt-4 text-center">
		<img src="/themes/simplebootx_mobile/Zt/20190307/imgs/2.jpg" alt="">
		<img src="/themes/simplebootx_mobile/Zt/20190307/imgs/3.jpg" alt="" />
		<div style="background: #ffe8a8;"><img src="/themes/simplebootx_mobile/Zt/20190307/imgs/4.gif" alt=""></div>
		<img src="/themes/simplebootx_mobile/Zt/20190307/imgs/5.jpg" alt="">
		<img src="/themes/simplebootx_mobile/Zt/20190307/imgs/6.jpg" alt="">
		<img src="/themes/simplebootx_mobile/Zt/20190307/imgs/7.jpg" alt="">
	</div>
	
	<div class="copy pt-2 pb-0" style="background: #ffc446;">
	...
	<div style="padding-bottom: 5.5rem;"><img src="/themes/simplebootx_mobile/Zt/20190307/imgs/8.jpg" alt=""></div>
	<div class="fixed fixed-bottom gotoform"><img src="/themes/simplebootx_mobile/Zt/20190307/imgs/fixed.jpg" /></div>
</body>
<script>
	$(function() {
		...
		var mySwiper = new Swiper('.swiper-container',{
	  	...
	  	$.post('/api/form/formdata2', {}, function(data) {
			// console.log(data)
			var html = '';
			for(var i = 0; i < data.length; i ++) {
				html += '<div class="swiper-slide text-center">'+
							...
							'<span class="d-inline-block ml-3">'+ data[i].award +'</span>'+
						'</div>';
			}
