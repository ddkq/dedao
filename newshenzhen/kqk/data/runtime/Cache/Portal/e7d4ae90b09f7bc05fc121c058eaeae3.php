<?php if (!defined('THINK_PATH')) exit();?><!--品牌荣誉-->
<!DOCTYPE html>
<html>
	<head>
	...
	<div class="brand_left_bd">
		<ul>
			...
			<div class="brand_right">
				...
				<div class="brand_rongyu_list">
					<ul class="clearfix">
					<!--
						<li class="big"><img src="/themes/simplebootx/Public/images/brand/ry_23.jpg" alt=""></li>
						<li class="big nomr"><img src="/themes/simplebootx/Public/images/brand/ry_23.jpg" alt=""></li>
						<li><img src="/themes/simplebootx/Public/images/brand/ry_01.jpg" alt=""></li>
						<li><img src="/themes/simplebootx/Public/images/brand/ry_01.jpg" alt=""></li>
						<li><img src="/themes/simplebootx/Public/images/brand/ry_01.jpg" alt=""></li>
						<li class="nomr"><img src="/themes/simplebootx/Public/images/brand/ry_01.jpg" alt=""></li>
						-->
					</ul>
				</div>
