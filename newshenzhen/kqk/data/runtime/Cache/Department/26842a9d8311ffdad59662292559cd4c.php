		...
		<ul>
			...
			<div class="brand_right">
				...
				<div class="brand_zj">
					<div class="con">
						<ul class="clearfix">
							<?php if(is_array($all_doctor)): $i = 0; $__LIST__ = array_slice($all_doctor,0,20,true);if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li class="clearfix w-48 d-inline-block p-3 border mr- position-relative">
