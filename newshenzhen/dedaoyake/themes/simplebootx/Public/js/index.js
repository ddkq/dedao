...
$(function() {
	...
	var point  = new BMap.Point(113.279302,23.136867)
	var point2  = new BMap.Point(113.279302,23.136867)
	map.centerAndZoom(point2, 19);

	map.addOverlay(new BMap.Marker(point));
	// var myIcon = new BMap.Icon("/APP/Public/images/map-logo.png", new BMap.Size(80,49));
	map.clearOverlays();
	var marker2 = new BMap.Marker(point,"广州德道医院管理有限公司"); // 创建标注
	...
	var sContent =  
		"<h4 style='margin:0 0 5px 0;padding:0.2em 0'>广州德道医院管理有限公司</h4>" +  
		"<p style='margin:0;line-height:1.5;font-size:13px;'>地址：广州市越秀区东风中路418号华以泰国际大厦602号室<br/>电话：400-800-6161</p>" +  
		"</div>";  
