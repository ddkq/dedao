			...
			<table class="table table-hover table-bordered">
				<thead>
					<tr>
						...
						<th width="50"><?php echo L('GENDER');?></th>
						<th width="100"><?php echo L('TEL');?></th>
						<th width="100"><?php echo L('DEPARTMENT');?></th>
						<th width="100"><?php echo L('DOCTOR');?></th>
						<th width="100"><?php echo L('TIME');?></th>
						<th width="100"><?php echo L('SICK');?></th>
						<th style="min-width: 120px;"><?php echo L('CONTENT');?></th>
						<th width="100"><?php echo L('STATUS');?></th>
						<th width="100"><?php echo L('ACTION');?></th>
					</tr>
				</thead>
				<tbody>
					<?php if(is_array($register)): foreach($register as $key=>$vo): ?><tr>
						...
						<td><?php echo $gender = $vo[gender]==0 ? '男':'女' ?></td>
						<td><?php echo ($vo["tel"]); ?></td>
						<td><?php echo ($vo["t_name"]); ?></td>
						<td><?php echo ($vo["d_name"]); ?></td>
						<td><?php echo ($vo["time"]); ?></td>
						<td><?php echo ($vo["sick"]); ?></td>
