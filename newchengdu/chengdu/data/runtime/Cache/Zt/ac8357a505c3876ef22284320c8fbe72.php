...
<html>
	<head>
	<meta charset="UTF-8">
	<title>·种植名医学术案例征集专场·_<?php echo ($site_name); ?></title>
...
<script>
	...
	<link href="/themes/simplebootx_mobile/Zt/20190626/index.css" rel="stylesheet" type="text/css">
...
<body>
	...
	<section class="gotoform"><img src="/themes/simplebootx_mobile/Zt/20190626/imgs/1.jpg" /></section>
	...
	<section class="pb-5">
		<form action="" class="container mt-3 mb-4">
			...
			<input type="hidden" name="table_id" value="61" />
		...
		<div class="">
			<img src="/themes/simplebootx_mobile/Zt/20190626/imgs/2.jpg"/>
			<img src="/themes/simplebootx_mobile/Zt/20190626/imgs/3.jpg"/>
			<div class="text-center mt-1 mb-1">
				<video controls="controls" autoplay="autoplay">
					<source src="/themes/simplebootx_mobile/Zt/20190626/imgs/mp4.mp4" type="video/mp4" />
				</video>
			</div>
			
			<img src="/themes/simplebootx_mobile/Zt/20190626/imgs/4.jpg"/>
			<img src="/themes/simplebootx_mobile/Zt/20190626/imgs/5.jpg"/>
			<img src="/themes/simplebootx_mobile/Zt/20190626/imgs/6.jpg"/>
			<img src="/themes/simplebootx_mobile/Zt/20190626/imgs/7.jpg"/>
		</div>
		<div class="position-relative container swiper-bg">
			<div class="swiper-container ">
					<div class="swiper-wrapper">
						<div class="swiper-slide"><img src="/themes/simplebootx_mobile/Zt/20190626/imgs/7-1.png"></div>
						<div class="swiper-slide"><img src="/themes/simplebootx_mobile/Zt/20190626/imgs/7-2.png"></div>
						<div class="swiper-slide"><img src="/themes/simplebootx_mobile/Zt/20190626/imgs/7-3.png"></div>
						<div class="swiper-slide"><img src="/themes/simplebootx_mobile/Zt/20190626/imgs/7-4.png"></div>
					</div>
				</div>
