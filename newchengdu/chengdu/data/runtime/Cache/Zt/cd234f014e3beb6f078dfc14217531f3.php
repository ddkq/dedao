...
<head>
	<meta charset="UTF-8">
	<title>妙手仁心·金口碑好医生_<?php echo ($site_name); ?></title>
	<head>
...
<script>
	...
	<script src="/themes/simplebootx/Public/js/swiper.min.js"></script>
	<link href="/themes/simplebootx/Zt/2018-12-07/index.css" rel="stylesheet" type="text/css">
</head>
<body>
	<header class="header">
...
<script>
	...
	<section class="banner"><img src="/themes/simplebootx/Zt/2018-12-07/imgs/banner.jpg" alt=""></section>

	<section class="mt-5"><img src="/themes/simplebootx/Zt/2018-12-07/imgs/banner-2.jpg" alt=""></section>

	<section class="content-1 mt-5 text-center">
		<div class="container">
			<h1 class="title position-relative">
				<p><b class="position-relative">蔡明河：接触新技术的医生</b></p>
				<p class="title-text">既 是 口 腔 颌 面 外 科 的 专 家 ，也 是 种 植 牙 名 医。</p>
			</h1>
		</div>
		<div class="mt-5 content-1-bcg position-relative">
			<div class="white-block position-absolute"></div>
			<div class="container">
				<div class="position-relative" style="z-index:2;">
					<img src="/themes/simplebootx/Zt/2018-12-07/imgs/content-1.png" alt="">
					<a onclick="openJesongChatByGroup(16524,20125);" class="swt-btn text-white position-absolute">立即预约</a>
				</div>
			</div>
		</div>
	</section>

	<section class="content-2 container mt-5">
		<h1 class="title position-relative text-center">
			<p><b class="position-relative">以技术实力获业界荣誉</b></p>
			<p class="title-text">以 其 精 湛 医 术 和 高 尚 品 德 为 医 疗 行 业 做 出 杰 出 贡 献。</p>
		</h1>
		<h3 class="text-center red mt-5 font-weight-bold">蔡院长再添一笔荣耀，收获“金口碑”</h3>
		<div class="swiper-container text-center mt-3">
			<div class="swiper-wrapper">
				<div class="swiper-slide"><img src="/themes/simplebootx/Zt/2018-12-07/imgs/content-2-banner-1.png" alt=""></div>
				<div class="swiper-slide"><img src="/themes/simplebootx/Zt/2018-12-07/imgs/content-2-banner-2.png" alt=""></div>
				<div class="swiper-slide"><img src="/themes/simplebootx/Zt/2018-12-07/imgs/content-2-banner-3.png" alt=""></div>
			</div>
			<div class="swiper-button-prev swiper-button-black"></div>
    		<div class="swiper-button-next swiper-button-black"></div>
		</div>
		<p class="text-indent pl-5 pr-5 content-2-text mt-3">11月10日上午，成都德道口腔医院蔡院长在5000余名医生中脱颖而出，荣获第六届“妙手仁心·金口碑好医生”口腔科十强好医生称号；并受活动方邀约，为市民提供义诊服务。</p>
	</section>

	<section class="content-3 pb-5 pt-5 mt-5">
		<div class="container text-center">
			<h3 class="red font-weight-bold">所获荣誉——是患者对于蔡院长治疗的认可</h3>
			<div class="mt-3"><img src="/themes/simplebootx/Zt/2018-12-07/imgs/content-3.png" alt=""></div>
		</div>
	</section>

	<section class="content-4 container mt-5 text-center">
		<h1 class="title position-relative">
			<p><b class="position-relative">用“即刻用3.0”技术服务患者，解决患者缺牙的烦恼</b></p>
			<p class="title-text">较 早 涉 足 口 腔 种 植 领 域 ， 深 谙 各 种 品 牌 种 植 系 统 。</p>
		</h1>
		<ul class="d-flex justify-content-between mt-5">
			<li><img src="/themes/simplebootx/Zt/2018-12-07/imgs/content-4-round-1.png" alt=""></li>
			<li><img src="/themes/simplebootx/Zt/2018-12-07/imgs/content-4-round-2.png" alt=""></li>
			<li><img src="/themes/simplebootx/Zt/2018-12-07/imgs/content-4-round-3.png" alt=""></li>
			<li><img src="/themes/simplebootx/Zt/2018-12-07/imgs/content-4-round-4.png" alt=""></li>
		</ul>
		<h3 class="name mt-5"><b class="position-relative red">蔡&nbsp;院&nbsp;长</b></h3>
		<p class="text-indent content-2-text mt-3">深耕口腔医学领域数十载，一直都铭记着初衷：“近一点，我希望能离口腔医学尖端技术再近一点”，<br>只为解决患者种牙的烦恼，免受传统种植牙的痛苦。2015年，就带领种植团队开展“即刻负重”种植牙技术。</p>
		<ul class="row justify-content-between mt-3">
			<li class="col-md-6"><img src="/themes/simplebootx/Zt/2018-12-07/imgs/content-4-1.jpg" alt=""></li>
			<li class="col-md-6"><img src="/themes/simplebootx/Zt/2018-12-07/imgs/content-4-2.jpg" alt=""></li>
			<li class="mt-4 col-md-6"><img src="/themes/simplebootx/Zt/2018-12-07/imgs/content-4-3.jpg" alt=""></li>
			<li class="mt-4 col-md-6"><img src="/themes/simplebootx/Zt/2018-12-07/imgs/content-4-4.jpg" alt=""></li>
		</ul>
		<a class="mt-3" onclick="openJesongChatByGroup(16524,20125);"><img src="/themes/simplebootx/Zt/2018-12-07/imgs/swt-img.jpg" alt=""></a>
	</section>

	<section class="content-5 mt-5 pt-5 pb-5">
		<div class="container">
			<h1 class="title position-relative text-center">
				<p><b class="position-relative">从患者的角度出发，尽心尽力去帮助患者</b></p>
				<p class="title-text">能 一 次 解 决 的 问 题 ， 不 让 患 者 费 二 遍 事 。</p>
			</h1>
			<p class="text-indent pl-5 pr-5 ml-5 mr-5 content-5-text mt-5 mb-5">很多其他口腔机构都难以接诊的高难种植手术，经过蔡院长仔细检查后，总会给出这样的答案：“可以克服，困难不大”。这正是因为其多年在口腔颌面外科的经验，且面对的基本都是大型手术、极高难度手术，所以很多的高难种植牙对他来说，也仅仅是普通病例。</p>
			<div class="pl-5 pr-5 ml-5 mr-5">
				<h3 class="case-title text-white text-center pt-2 pb-2">曾被多家医院拒绝，蔡院长一口接下了这个任务</h3>
				<div class="pl-5 pr-5 mt-4">
					<h4>王大爷 — 72岁</h4>
					<p class="line pb-3"><b>口腔情况：</b>骨头条件差，牙床太薄，戴活动假牙也戴不住，种植牙难度大，很多医院都拒绝为他治疗。</p>
					<p><b>解决方案：</b>手术难度很大，需要植骨的部位紧挨鼻腔下缘，下颌有多条神经分布，种植不能打得太深，蔡院长在下牙上艰难种植了4颗种植体，下牙上种植5颗种植体，支撑了整口牙，实现了王大爷的愿望。</p>
				</div>
				<div class="mt-4"><img src="/themes/simplebootx/Zt/2018-12-07/imgs/case.png" alt=""></div>
			</div>
			
			<div class="mt-4 text-center">
				<a onclick="openJesongChatByGroup(16524,20125);" class="swt-btn text-white mr-3 ml-3">咨询专家牙齿问题</a>
				<a onclick="openJesongChatByGroup(16524,20125);" class="swt-btn text-white mr-3 ml-3" style="background: #333;">立即预约蔡院长看牙</a>
			</div>
		</div>
	</section>
