...
<html>
	<head>
	<meta charset="UTF-8">
	<title>618_<?php echo ($site_name); ?></title>
...
<script>
	...
	<link href="/themes/simplebootx_mobile/Zt/20190611/index.css" rel="stylesheet" type="text/css">
...
<body>
	<section class=""><img src="/themes/simplebootx_mobile/Zt/20190611/imgs/1.jpg" /></section>
	<section class="container pb-2">
		<form action="" class="mt-3 mb-4">
			<p class="mb-1">牙齿症状：</p>
			<div class="symptom text-center mb-3">
				<font class="d-inline-block pt-2 pb-2 mr-1 mb-2 active">烤瓷牙失败</font>
				<font class="d-inline-block pt-2 pb-2 mr-1 mb-2 ">多颗缺牙</font>
				<font class="d-inline-block pt-2 pb-2 mr-1 mb-2 ">缺大牙/门牙</font>
				<font class="d-inline-block pt-2 pb-2 mr-1 mb-2 ">半口缺牙</font>
				<font class="d-inline-block pt-2 pb-2 mr-1 mb-2 ">全口缺牙</font>
				<font class="d-inline-block pt-2 pb-2 mr-1 mb-2 ">其他牙齿情况</font>
				<input type="hidden" class="symptom-value" name="data[symptom]" value="烤瓷牙失败">
			</div>
			...
			<input type="hidden" name="table_id" value="60" />
		...
		<p class="text-center pt-2 mb-3">
			<a href="javascript:;" class="text-center text-white w-75 submit-btn pt-2 pb-2 d-inline-block">马上领取</a>
		</p>
		<h4 class="text-center">——免费种植体名额还有——</h4>
		<div class="num d-flex justify-content-center">
			<div class="mr-1">1</div>
			<div class="mr-1"><?php echo ($code = mt_rand(0,9)); ?></div>
			<div class="mr-1"><?php echo ($code = mt_rand(0,9)); ?></div>
		</div>
	</section>
	<div class="">
		<img src="/themes/simplebootx_mobile/Zt/20190611/imgs/2.jpg"/>
		<img src="/themes/simplebootx_mobile/Zt/20190611/imgs/3.jpg"/>
		<img class="container" src="/themes/simplebootx_mobile/Zt/20190611/imgs/4.gif"/>
		<img src="/themes/simplebootx_mobile/Zt/20190611/imgs/5.jpg"/>
		<img src="/themes/simplebootx_mobile/Zt/20190611/imgs/6.jpg"/>
		<img src="/themes/simplebootx_mobile/Zt/20190611/imgs/7.jpg"/>
		<img src="/themes/simplebootx_mobile/Zt/20190611/imgs/8.jpg"/>
	</div>
	<div class="position-relative container pb-5 swiper-bg">
		<div class="swiper-container ">
			<div class="swiper-wrapper">
				<div class="swiper-slide"><img src="/themes/simplebootx_mobile/Zt/20190611/imgs/9-1.png"></div>
				<div class="swiper-slide"><img src="/themes/simplebootx_mobile/Zt/20190611/imgs/9-2.png"></div>
				<div class="swiper-slide"><img src="/themes/simplebootx_mobile/Zt/20190611/imgs/9-3.png"></div>
			</div>
		</div>
		<div class="swiper-pagination mt-2 mb-5"></div>	
	</div>
	<div class="copy">
	...
	<img src="/themes/simplebootx_mobile/Zt/20190611/imgs/10.jpg"  style="margin-bottom: 6rem;"/>
