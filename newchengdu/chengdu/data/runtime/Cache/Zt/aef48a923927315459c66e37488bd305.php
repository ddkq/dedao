...
<html>
	<head>
	<meta charset="UTF-8">
	<title>50岁以上多颗缺牙市民种一颗送一颗<?php echo ($site_name); ?></title>
...
<script>
	...
	<link href="/themes/simplebootx_mobile/Zt/20190518/index.css" rel="stylesheet" type="text/css">
...
<body>
	...
	<section class="gotoform"><img src="/themes/simplebootx_mobile/Zt/20190518/imgs/1.jpg" /></section>
	...
	<section class="pb-5">
		<form action="" class="container mt-3 mb-4">
			...
			<div class="symptom text-center mb-3">
				...
				<input type="hidden" class="symptom-value" name="data[symptom]" value="缺大牙/门牙">
			</div>
		...
		<p class="text-center pt-2 mb-3">
			<a href="javascript:;" class="text-center text-white w-75 submit-btn pt-2 pb-2 d-inline-block">抢占名额</a>
		</p>
		<div class="">
			<img src="/themes/simplebootx_mobile/Zt/20190518/imgs/2.jpg"/>
			<div class="text-center mt-1 mb-1">
				<video controls="controls" autoplay="autoplay">
					<source src="/themes/simplebootx_mobile/Zt/20190518/imgs/mp4.mp4" type="video/mp4" />
				</video>
			</div>
			<img src="/themes/simplebootx_mobile/Zt/20190518/imgs/3.jpg"/>
			<img src="/themes/simplebootx_mobile/Zt/20190518/imgs/4.jpg"/>
			<img src="/themes/simplebootx_mobile/Zt/20190518/imgs/5.jpg"/>
			<img src="/themes/simplebootx_mobile/Zt/20190518/imgs/66.jpg"/>
		</div>
		<div class="position-relative container swiper-bg">
			<div class="swiper-container ">
					<div class="swiper-wrapper">
						<div class="swiper-slide"><img src="/themes/simplebootx_mobile/Zt/20190518/imgs/6-1.png"></div>
						<div class="swiper-slide"><img src="/themes/simplebootx_mobile/Zt/20190518/imgs/6-2.png"></div>
						<div class="swiper-slide"><img src="/themes/simplebootx_mobile/Zt/20190518/imgs/6-3.png"></div>
						<div class="swiper-slide"><img src="/themes/simplebootx_mobile/Zt/20190518/imgs/6-4.png"></div>
					</div>
				</div>
...
<script type="text/javascript">
	$(function() {
		...
		$('video').css('width',$(window).width()-10);
