...
<head>
	<meta charset="UTF-8">
	<title>成都月度技术监督员_<?php echo ($site_name); ?></title>
...
<script>
	...
	<link href="/themes/simplebootx_mobile/Zt/20190402/index.css" rel="stylesheet" type="text/css">
...
<nav class="header-nav position-fixed">
	...
	<section class="banner"><img src="/themes/simplebootx_mobile/Zt/20190402/imgs/1.jpg" alt=""></section>

	<section class="container">
		<form action="" class="mt-3 mb-4">
			<div class="mb-3">您的牙齿情况</div>
			<div class="symptom mb-3">
				<font class="d-inline-block pt-2 pb-2 mr-2 mb-2 active">缺门牙/大牙</font>
				<font class="d-inline-block pt-2 pb-2 mr-2 mb-2 ">多颗牙缺失</font>
				<font class="d-inline-block pt-2 pb-2 mr-2 mb-2 ">半口牙缺失</font>
			...
			<input type="text" class="w-100 pt-3 pb-3 mt-3 phone"  name="data[phone]" placeholder="电话">
			<input type="text" class="w-100 pt-3 pb-3 mt-3 age"  name="data[age]" placeholder="年龄">
	...
	<section class="mt-3"><img src="/themes/simplebootx_mobile/Zt/20190402/imgs/2.jpg" alt=""></section>
	<section class="gotoform"><img src="/themes/simplebootx_mobile/Zt/20190402/imgs/3.jpg" alt=""></section>
	<section><img src="/themes/simplebootx_mobile/Zt/20190402/imgs/4.jpg" alt=""></section>
	<section><img src="/themes/simplebootx_mobile/Zt/20190402/imgs/5.jpg" alt=""></section>
	<section class="container"><img src="/themes/simplebootx_mobile/Zt/20190402/imgs/6.gif" alt=""></section>
	<section><img src="/themes/simplebootx_mobile/Zt/20190402/imgs/7.jpg" alt=""></section>
	<section><img src="/themes/simplebootx_mobile/Zt/20190402/imgs/8.jpg" alt=""></section>
	<div class="copy">
