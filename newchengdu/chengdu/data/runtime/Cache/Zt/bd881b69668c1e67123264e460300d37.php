...
<script>
	...
	<link rel="stylesheet" href="/themes/simplebootx/Zt/lgmb/css/css.css">
	<title>冷光美白_<?php echo ($site_name); ?></title>
</head>
<body>
	<header class="header">
...
<script>
	...
	<div class="daoyu">
		<span>3毫米深层美白牙齿，美丽不用等</span>
	    <p>根据牙齿结构形态学显示，在牙齿结构中存在牙本质小管，自牙髓表面像牙本质界呈放射状排列贯穿整个牙齿。其直径为3-4微米，越向表面越细，近表面约为1微米，且排列稀疏。德道口腔冷光美白采用低浓度亲水性美白剂，以低温蓝光照射，通过光纤传导，将美白剂渗入牙齿微孔内，深度高效美白，对牙齿无任何副作用，轻松提高牙齿色度5－14个vita色阶。</p>
	    <a onclick="openJesongChatByGroup(16524,20125);">我要直接对话专业医生</a>
	</div>

	<div class="cont main_01">
		<div class="tlt"><h1>为了让牙齿变白，你是不是尝试过…</h1></div>
		<ul>
	    	<li><img src="/themes/simplebootx/Zt/lgmb/imgs/mb1.jpg"></li>
	        <li><img src="/themes/simplebootx/Zt/lgmb/imgs/mb2.jpg"></li>
	        <li><img src="/themes/simplebootx/Zt/lgmb/imgs/mb3.jpg"></li>
	        <li><img src="/themes/simplebootx/Zt/lgmb/imgs/mb4.jpg"></li>
	        <li><img src="/themes/simplebootx/Zt/lgmb/imgs/mb5.jpg"></li>
	        <li style="margin-right:0px;"><img src="/themes/simplebootx/Zt/lgmb/imgs/mb6.jpg"></li>
	    </ul>
	    <div class="bor_t">
	    	<span class="bor_s1"><i></i>牙齿美白液</span>
	        <span class="bor_s2"><i></i>美白牙膏</span>
	        <span class="bor_s3"><i></i>食醋</span>
	        <span class="bor_s4"><i></i>柠檬汁</span>
	        <span class="bor_s5"><i></i>美白牙托</span>
	        <span class="bor_s6"><i></i>橘子皮</span>
	    </div>
	</div>
	<div class="cont main_02">
		<div class="tlt"><h1>然而，你费尽心力搜集的秘方，结果…</h1></div>
	    <div class="main_02_i"><img src="/themes/simplebootx/Zt/lgmb/imgs/shy.jpg"></div>
	    <p>牙齿美白若缺乏医生的指导，可能美白效果并不佳，且有误用和过量使用的危险。另外，市场上一些牙齿美白药剂多含有过氧化氢，过硼酸钠等漂白剂成分，不当使用容易引起牙齿敏感、牙龈刺激出血、牙根外吸收等不良反应。</p>
	    <a onclick="openJesongChatByGroup(16524,20125);">遇到了以上问题？点击这里咨询</a>
	</div>

	<div class="main_03">
		<div class="main_03_i"><img src="/themes/simplebootx/Zt/lgmb/imgs/sejie.jpg"></div>
	    <a onclick="openJesongChatByGroup(16524,20125);">点击查询你的牙齿色阶</a>
	</div>

	<div class="cont main_04">
	    <div class="tlt"> <h1>德道口腔冷光美白，不仅美白，更保护牙釉质</h1></div>
	    <div class="main_04_p">德道口腔冷光美白技术经全球150多国200万人成功验证，在治疗过程中更加强调牙齿的色泽、光滑度、契合度，保护牙釉质的同时，实现深层次的美白蜕变。数年来，超万名顾客在德道口腔美白牙齿，78%以上的顾客提高8—16个VITA色阶！</div>
	    <div class="main_04_i"><img src="/themes/simplebootx/Zt/lgmb/imgs/lgmb.jpg"></div>
	    <div class="main_04_hd">
	    	<ul>
	        	<li class="on">无痛护齿技术<i><img src="/themes/simplebootx/Zt/lgmb/imgs/ici.png"></i></li>
	            <li>高效美白<i><img src="/themes/simplebootx/Zt/lgmb/imgs/ici.png"></i></li>
	            <li>效果持久<i><img src="/themes/simplebootx/Zt/lgmb/imgs/ici.png"></i></li>
	            <li>安全放心<i><img src="/themes/simplebootx/Zt/lgmb/imgs/ici.png"></i></li>
	            <li>节省时间<i><img src="/themes/simplebootx/Zt/lgmb/imgs/ici.png"></i></li>
	        </ul>
	    </div>
	    <div class="main_04_bd">
	    	<ul>
	        	<li>
	            	<p>经过特殊处理的低温照射，不需要涂抹或注射麻醉，降低了操作过程中对牙神经造成的不适，完全避免了操作中对于牙神经的刺激。</p>
	            </li>
	            <li style="display: none;">
	            	<p>特殊蓝光照射，有效催化专利美白凝胶，在不改变牙齿结构的情况下，约15分钟就能产生明显的美白效果，1次治疗提升5-14个色阶。</p>
	            </li>
	            <li style="display: none;">
	            	<p>蓝光照射后，去除牙齿深层的色素沉积，让漂白作用渗透到牙釉质和牙本质，美白效果可持续约5年。</p>
	            </li>
	            <li style="display: none;">
	            	<p>经过国际认证的美白剂，在牙齿脱色上已经投入使用超数十年，且仪器有24V的低电压及防水性能，使操作绝对安全。</p>
	            </li>
	            <li style="display: none;">
	            	<p>美白精度高，一次美白操作只需要大约60分钟即可完成，完全不会耽误您的多余时间，被称为牙齿的“午间美容”。</p>
	            </li>
	        </ul>
	    </div>
	    <div class="main_04_a"><a onclick="openJesongChatByGroup(16524,20125);">拨打免费热线：400-800-6161 &nbsp;&nbsp; 我也要美白牙齿</a></div>
	</div>
	<script></script>

	<div class="cont main_05">
		<div class="tlt"><h1>60分钟变个色号？牙齿美白如此简单！</h1></div>
		<div class="main_05_b">
	    	<div class="main_05_i"><img src="/themes/simplebootx/Zt/lgmb/imgs/mbsj.jpg"></div>
	        <span>德道口腔冷光无痛护齿美白过程</span>
	        <div class="mngc">
	        	<p>治疗前拍照存档 1min</p>
	            <p>简单处理牙齿表面 4min</p>
	            <p>首次照射 12min</p>
	            <p>二次照射 12min</p>
	            <p>三次照射 12min</p>
	            <font>（温馨提示：医生会根据牙色情况调整治疗时间）</font>
	        </div>
	    </div>
	</div>

	<div class="main_06 cont">
		<div class="tlt"><h1>见证皓齿蜕变，变身美牙达人</h1></div>
	    <div class="anl_bd">
	    	<ul>
	        	<li>
	            	<div class="anl_img"><img src="/themes/simplebootx/Zt/lgmb/imgs/anli1.jpg"></div>
	                <div class="anl_txt">
	                	<p><b>病况：</b>遗传性黄牙</p>
	                    <p><b>治疗时间：</b>1次性治疗，3个10分钟照射</p>
	                    <p><b>治疗效果：</b>美白前 A3，美白后 B1，提高了8个VITA色阶</p>
	                    <span><img src="/themes/simplebootx/Zt/lgmb/imgs/an1mb1.jpg"><font>美白前</font></span>
	                    <span><img src="/themes/simplebootx/Zt/lgmb/imgs/an1mb2.jpg"><font>美白后</font></span>
	                </div>
	            </li>
	            <li style="display: none;">
	            	<div class="anl_img"><img src="/themes/simplebootx/Zt/lgmb/imgs/anli2.jpg"></div>
	                <div class="anl_txt">
	                	<p><b>病况：</b>四环素牙</p>
	                    <p><b>治疗时间：</b>一次性治疗，3 个10分钟照射</p>
	                    <p><b>颜色：</b>美白前 A3.5，美白后 B1，提高了11个VITA色阶</p>
	                    <span><img src="/themes/simplebootx/Zt/lgmb/imgs/an2mb1.jpg"><font>美白前</font></span>
	                    <span><img src="/themes/simplebootx/Zt/lgmb/imgs/an2mb2.jpg"><font>美白后</font></span>
	                </div>
	            </li>
	            <li style="display: none;">
	            	<div class="anl_img"><img src="/themes/simplebootx/Zt/lgmb/imgs/anli3.jpg"></div>
	                <div class="anl_txt">
	                	<p><b>病况：</b>中度黄牙</p>
	                    <p><b>治疗时间：</b>一次性治疗,3个10分钟照射。</p>
	                    <p><b>颜色：</b>美白前 B3，美白后 B2，提高了8个VITA色阶。</p>
	                    <span><img src="/themes/simplebootx/Zt/lgmb/imgs/an3mb1.jpg"><font>美白前</font></span>
	                    <span><img src="/themes/simplebootx/Zt/lgmb/imgs/an3mb2.jpg"><font>美白后</font></span>
	                </div>
	            </li>
	        </ul>
	    </div>
	    <div class="anl_hd">
	    	<ul>
	        	<li class="on"><span class="anl_1"></span></li>
	            <li><span class="anl_2"></span></li>
	            <li><span class="anl_3"></span></li>
	        </ul>
	    </div>
	</div>

	<div class="main_07">
		<div class="zj_l"><span>智能口腔专家团</span><img src="/themes/simplebootx/Zt/lgmb/imgs/zj.jpg"></div>
	    <div class="zj_t">
	    	<span>谭晨珊</span>
	        <font>中华口腔医学会会员<br>美学修复医师</font>
	        <p><b>擅长：</b>冷光美白、烤瓷牙修复、美学全瓷牙修复、超薄水晶瓷贴面等</p>
	        <a class="zja1" onclick="openJesongChatByGroup(16524,20125);">在线自助挂号</a>
	        <a class="zja2" onclick="openJesongChatByGroup(16524,20125);">点击网络咨询</a>
	    </div>
	</div>
...
<script>
	...
	<script>
		jQuery(".main_04").slide({titCell:".main_04_hd ul li",mainCell:".main_04_bd ul"});
		jQuery(".main_06").slide({titCell:".anl_hd ul li",mainCell:".anl_bd ul"});
	</script>
