...
<script>
	...
	<div class="cont main_01">
	    ...
	    <div class="bing_r"><img src="/themes/simplebootx/Zt/ztm/imgs/ycfh.png"><span>牙齿发黄、不整齐，我不要因为牙齿问题而烦恼！</span><a onclick="openJesongChatByGroup(16524,20125);">&gt;&gt;明星瓷贴面一键解决牙齿问题</a></div>
	</div>
	<div class="cont main_02">
	    ...
	    <div class="on_line">
	    	<span>告诉医生您的牙齿问题</span><a onclick="openJesongChatByGroup(16524,20125);">在线获取解决方案</a>
	    </div>
	</div>
	    ...
	    <ul>
	    	<li>
	            ...
	            <div class="main_03_p">
	                ...
	                <b>有效解决黄牙、黑牙、色素牙等问题 
	                	<a onclick="openJesongChatByGroup(16524,20125);">查看美白效果</a>
	                </b>
	            </div>
	        </li>
	        <li>
	            <div class="main_03_p2">
	                ...
	                <b>有效解决牙齿空隙、门牙缝隙过大等问题
	                	<a onclick="openJesongChatByGroup(16524,20125);">点击美学修复</a>
	                </b>
	            </div>
	        ...
	        <li>
	            ...
	            <div class="main_03_p">
	                ...
	                <b>有效解决牙齿不均匀、排列不整齐等问题
	                	<a onclick="openJesongChatByGroup(16524,20125);"> 矫正效果好不好</a>
	                </b>
	            </div>
	        </li>
	    </ul>
	...
	<div class="main_04 cont">
	    ...
	    <div class="main_04_a"><a onclick="openJesongChatByGroup(16524,20125);">在线咨询牙齿美学修复专家<img src="/themes/simplebootx/Zt/ztm/imgs/icon_sv.png"></a></div>
	</div>
	<div class="cont main_05">
	    ...
	    <a class="main_05_a1" onclick="openJesongChatByGroup(16524,20125);">400-800-6161   咨询专家</a><a class="main_05_a2" onclick="openJesongChatByGroup(16524,20125);">免费定制美牙</a>
	</div>
	<div class="main_06 cont">
	    ...
	    <a onclick="openJesongChatByGroup(16524,20125);">我也要拥有靓丽美牙，点此预约</a>
	</div>
	<div class="main_07 cont">
	    ...
	    <ul>
	    	<li>
	    		<a onclick="openJesongChatByGroup(16524,20125);"><img src="/themes/simplebootx/Zt/ztm/imgs/zj1.jpg"></a>
	    	</li>
	        <li>
	        	<a onclick="openJesongChatByGroup(16524,20125);"><img src="/themes/simplebootx/Zt/ztm/imgs/zj2.jpg"></a>
	        </li>
	        <li style="margin-right:0px;">
	        	<a onclick="openJesongChatByGroup(16524,20125);"><img src="/themes/simplebootx/Zt/ztm/imgs/zj3.jpg"></a>
	        </li>
	    </ul>
	</div>
	<div class="atbg cont">
