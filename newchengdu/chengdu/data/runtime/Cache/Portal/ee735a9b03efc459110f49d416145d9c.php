...
<nav class="header-nav position-fixed">
	<ul class="d-flex justify-content-between">
		...
		<div class="content2 w-100">
			<div class="index_service w-100">
				<ul class="d-flex flex-wrap service-list">
			...
			<ul>
				<?php if(is_array($brand)): $i = 0; $__LIST__ = $brand;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li>
						<div class="compatible-flex">
							...
							<a href="#" onclick="openJesongChatByGroup(16524,20125);" target="_blank" class="brand_info">
