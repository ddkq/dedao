...
<nav class="header-nav position-fixed">
	<ul class="flex">
		...
		<div class="brand_main clearfix">
				...
				<div class="contacts_main clearfix">
					<a class="media box_01 tel" href="tel:4008006161">
						<div class="media-left media-middle">
							<i class="fa fa-phone"></i>
						</div>
						<div class="media-body">
							<p class="title">电话</p>
							<p>400-800-6161/028-67696635</p>
							<p>工作时间：周一至周日</p>
						</div>
					</a>
					<a class="media box_01 liaotian" onclick="javascript:openJesongChatByGroup(16524,20125);">
						<div class="media-left media-middle">
							<i class="fa fa-comments-o"></i>
						</div>
						<div class="media-body">
							<p class="title">联系我们</p>
							<p>地址:成都市青羊区金凤路19号附1号</p>
						</div>
					</a>
				</div>
				<div class="traffic_box">
				    <div id="allmap" style="height:20rem;width:90%;margin: 0 auto;"></div>
				</div>			
...
<script>
	...
	<script type="text/javascript" src="/themes/simplebootx_mobile/Public/js/brand.js"></script>
