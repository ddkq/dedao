...
<nav class="header-nav position-fixed">
	...
	<section class="content1 text-center">
		...
		<div><a onclick="javascript:openJesongChatByGroup(16524,20125);" class="consult writening-btn color-red">我要咨询 >></a></div>
	</section>
	...
	<section class="content2">
		<div class="understand text-center">
			...
			<p class="content-second-title">
				<a onclick="javascript:openJesongChatByGroup(16524,20125);">种植牙寿命</a>
				<a onclick="javascript:openJesongChatByGroup(16524,20125);" class="left-line">种植牙有风险吗</a>
				<a onclick="javascript:openJesongChatByGroup(16524,20125);" class="left-line">种植牙价格</a>
			</p>
		</div>
		<div>
		...
		<div class="advantage clearfix">
			...
			<div class="col-xs-5">
				...
				<div class="text-center design-online">
					<a onclick="javascript:openJesongChatByGroup(16524,20125);" class="design">点击在线设计方案</a>
				</div>	
			</div>
