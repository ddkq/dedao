	...
	<div class="main-container container-fluid">
		...
		<div class="sidebar" id="sidebar">
			...
			<ul class="nav nav-list">
				<?php $admin_id = sp_get_current_admin_id(); ?>
				<?php if($admin_id == 18): ?><li class="open">
						<a href="#" class="dropdown-toggle">
							<i class="fa fa-caret-right"></i>
						...
						<ul class="submenu" style="display: block;">
							<li>
								<a href="javascript:openapp('/Questionnaire/AdminQuestionnaire/index/menuid/453.html','453Questionnaire','问卷管理',true);">
									&nbsp;<i class="fa fa-angle-double-right"></i>
									<span class="menu-text">问卷管理</span>
								</a>
							</li>
							<li>
								<a href="javascript:openapp('/Questionnaire/AdminQuestionnaire/data_lists/menuid/454.html','454Questionnaire','数据查看',true);">
									&nbsp;<i class="fa fa-angle-double-right"></i>
					...
					<li class="open">
						...
						<ul class="submenu" style="display: block;">
							<li>					
								<a href="javascript:openapp('/Award/Adminaward/set/menuid/456.html','456Award','抽奖配置',true);">
								&nbsp;<i class="fa fa-angle-double-right"></i>
								<span class="menu-text">抽奖配置</span>
								</a>
							</li>
						</ul>						
					</li>
				<?php else: ?>
					<li class="open">
						...
						<ul class="submenu" style="display: block;">
							<li>
								<a href="javascript:openapp('/Tables/AdminTables/view_data/menuid/387.html','387Tables','数据管理',true);">
									&nbsp;<i class="fa fa-angle-double-right"></i>
									<span class="menu-text">数据管理</span>
								</a>
							</li>
							<li>
								<a href="javascript:openapp('/Tables/AdminTables/index/menuid/381.html','381Tables','表单管理',true);">
									&nbsp;<i class="fa fa-angle-double-right"></i>
									<span class="menu-text">表单管理</span>
								</a>
							</li>
					...
					<li>
						<a href="#" class="dropdown-toggle">
							<i class="fa fa-caret-right"></i>
							<span class="menu-text">挂号信息</span>
							<b class="arrow fa fa-angle-right"></b>
						</a>
						<ul class="submenu" style="display: block;">
							<li>
								<a href="javascript:openapp('/api/registeradmin/index/menuid/321.html','321Api','挂号信息',true);">	
								&nbsp;<i class="fa fa-angle-double-right"></i> 
								<span class="menu-text">挂号信息</span>
								</a> 
							</li>
