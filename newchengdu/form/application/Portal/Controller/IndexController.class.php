	...
	public function index() {
		...
		if($phone){
	    	...
	    	foreach ($sick1 as $key => $value) {
	    		$sick1[$key]['commended_article'] = sp_sql_post_where($value['term_id'],'field:tid,post_title,post_excerpt,link_type,post_url,post_modified;',array('recommended'=>1,'recommended_type'=>42));
	    	...
	    	foreach ($sick2 as $key => $value) {
	    		$sick2[$key]['commended_article'] = sp_sql_post_where($value['term_id'],'field:tid,post_title,post_excerpt,link_type,post_url,post_modified;',array('recommended'=>1,'recommended_type'=>42));
	    	...
	    	foreach ($sick3 as $key => $value) {
	    		$sick3[$key]['commended_article'] = sp_sql_post_where($value['term_id'],'field:tid,post_title,post_excerpt,link_type,post_url,post_modified;',array('recommended'=>1,'recommended_type'=>42));
	    	...
	    	foreach ($sick4 as $key => $value) {
	    		$sick4[$key]['commended_article'] = sp_sql_post_where($value['term_id'],'field:tid,post_title,post_excerpt,link_type,post_url,post_modified;',array('recommended'=>1,'recommended_type'=>42));
	    	...
	    	foreach ($sick5 as $key => $value) {
	    		$sick5[$key]['commended_article'] = sp_sql_post_where($value['term_id'],'field:tid,post_title,post_excerpt,link_type,post_url,post_modified;',array('recommended'=>1,'recommended_type'=>42));
